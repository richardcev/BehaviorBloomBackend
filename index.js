...
app.use(express.json()); // Permite leer el JSON que envías desde el form
...
// Endpoint que recibirá el POST de React
app.post('/api/recruitment', async (req, res) => {
  ...
  try {
    ...
    await transporter.sendMail({
      from: `"Recruitment Portal" <${process.env.SMTP_USER}>`,
      to: process.env.EMAIL_TO, // A quién le llega el correo
